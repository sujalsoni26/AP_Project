...
public class Pillar {
    private static Timeline timelinePillar;
...
//        pillarArrayList.add(this);
    ...
    public static Timeline getTimelinePillar() {
        return Pillar.timelinePillar;
    }
    ...
    public static ParallelTransition getParallelTransition() {
        return Pillar.parallelTransition;
    }

    private static TranslateTransition moveHero1;

    public static TranslateTransition getMoveHero1() {
        return Pillar.moveHero1;
    }

    private static TranslateTransition moveHero2;

    public static TranslateTransition getMoveHero2() {
        return Pillar.moveHero2;
    }
...
//        KeyValue hero1 = new KeyValue(hero.translateXProperty(), )
        ...
        moveHero1 = new TranslateTransition(Duration.millis(500), hero);
        moveHero2 = new TranslateTransition(Duration.millis(500), hero);
        ...
        moveHero1.setOnFinished(e->{
            ...
            parallelTransition = new ParallelTransition(moveHero2, timelinePillar);
    ...
    double calculateDistance(Rectangle pillar1, Rectangle pillar2) {
